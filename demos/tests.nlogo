...
to test-sync-chat
  ...
  print (word "Sync chat result: " result)
end
...
to test-async-chat
  ...
  let result runresult async-reporter
  print (word "Async chat result: " result)
end
...
to test-choose
  ...
  print (word "Choose result: " chosen)
end
@#$#@#$#@
GRAPHICS-WINDOW
210
